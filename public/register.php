        ...
        <div id="doctor_register" class=" col-12  ">
            ...
            <form class="col-12">
              ...
              <div class="form-group col-md-6 ">
                ...
                <input type="text" class="form-control" id="Phone" placeholder="write your Phone">
              </div>
                           <div class="form-group col-md-6 ">
                <label for="age" class="col-12">Age</label>
      
                  <select aria-label="Day" name="birthday_day" id="day" title="Day" class="col-md-4 custom-select   selbox" >
                  ...
                  <select aria-label="Month" name="birthday_month" id="month" title="Month" class="col-md-4  custom-select selbox" >
                  ...
                  <select aria-label="Year" name="birthday_year" id="year" title="Year" class="col-md-4  custom-select selbox" >
              ...
              <div class="form-group col-md-6 ">
                ...
                <input type="text" class="form-control" id="Position" placeholder="doctor/marketing">
              </div>

            
               <div class="form-group col-md-6">
                <label for="Address">Job Resume</label>
              ...
              <div class="form-group col-md-6 ">
                ...
                <input type="text" class="form-control" id="Department" placeholder="Eye/Heart">
              </div>
              <div class="form-group col-md-6">
              ...
              <div class="form-group col-md-6 ">
                ...
                <input type="text" class="form-control" id="salary" placeholder="your salary">
              </div>
              ...
              <div class="form-group col-md-12">
                <label for="deacription">Job Deacription</label>
                <textarea class="form-control" id="deacription" rows="3"></textarea>
              </div>
              <div class="form-group col-md-12">
              ...
              <div class="input-group col-md-10 mb20">
              ...
              <button type="button" class="btn btn-outline-secondary col-md-2 mb20">Submit</button>  
            </div>
