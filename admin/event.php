  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="gallary col-12">
      	<div class="row">
             <legend class="col-12">Event Upload 
                  <button class="btn btn-outline-secondary float-right"><a href="event_view.php">View Event</a></button>
              </legend>
      		  <form class="col-6 mb20" action="../server/event_management.php" method="post" enctype="multipart/form-data">               
                ...
                <div class="input-group col-md-12 float-left ">
                  <button type="submit" class="btn btn-outline-secondary btn-block" name="Submit" value="add_event">Submit</button>
                </div>
            </form>
